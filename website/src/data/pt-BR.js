...
const data = {
  ...
  features: [
    { icon: '⚡', title: 'Zero Alocação',            desc: 'O VlkTask baseado em struct evita pressão no heap em todo caminho de sucesso. Tasks concluídas são gratuitas.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await VlkTask.WhenAll(...) — até 8 resultados tipados. WhenAny retorna o primeiro resultado concluído com seu índice.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'VlkTaskSettings.UnobservedExceptionHandler é configurável pelo usuário. Padrão: registra em Debug.LogException para que nenhuma exceção seja silenciosa.',
      },
    },
  ],
  ...
  cta: {
    ...
    p1:         'Gratuito para pessoas físicas e estúdios com receita anual abaixo de US$ 1 milhão.',
