...
const data = {
  ...
  features: [
    { icon: '⚡', title: 'Cero Asignaciones',          desc: 'VlkTask basado en struct evita la presión en el montón en cada camino de éxito. Las tareas completadas son gratuitas.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await VlkTask.WhenAll(...) — hasta 8 resultados tipados. WhenAny devuelve el primer resultado completado con su índice.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'VlkTaskSettings.UnobservedExceptionHandler es configurable por el usuario. Por defecto: registra en Debug.LogException para que ninguna excepción sea nunca silenciosa.',
      },
    },
  ],
