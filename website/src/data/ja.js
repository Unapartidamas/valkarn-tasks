...
const data = {
  ...
  features: [
    { icon: '⚡', title: 'ゼロアロケーション',        desc: '構造体ベースのValkarnTaskはすべての成功パスでヒープ負荷を回避します。完了済みタスクはコストゼロです。' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await ValkarnTask.WhenAll(...) — 最大8つの型付き結果。WhenAnyは最初に完了した結果とそのインデックスを返します。',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'ValkarnTaskSettings.UnobservedExceptionHandlerはユーザーが設定可能です。デフォルトはDebug.LogExceptionへのログ記録なので、例外が暗黙的に失われることはありません。',
      },
    },
  ],
  ...
  cta: {
    ...
    p1:         'MITオープンソース — 誰でも無料。オプションの商用ライセンスあり。',
