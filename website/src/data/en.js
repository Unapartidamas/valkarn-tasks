...
const data = {
  hero: {
    pill:  'Unity 2023.1+ · Free for indie',
    h1:    'Async/await',
  ...
  features: [
    { icon: '⚡', title: 'Zero Allocation',        desc: 'Struct-based VlkTask avoids heap pressure on every success path. Completed tasks are free.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await VlkTask.WhenAll(...) — up to 8 typed results. WhenAny returns the first completed result with its index.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'VlkTaskSettings.UnobservedExceptionHandler is user-configurable. Default: logs to Debug.LogException so no exception is ever silent.',
      },
    },
  ],
  ...
  cta: {
    ...
    p1:         'Free for individuals and studios under $1M/year revenue.',
