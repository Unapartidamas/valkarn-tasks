...
const data = {
  hero: {
    pill:  'Unity 2023.1+ · Gratuit pour les indépendants',
    h1:    'Async/await',
    h1Grad:'sans garbage.',
  ...
  features: [
    { icon: '⚡', title: 'Zéro Allocation',               desc: 'VlkTask basé sur une struct évite la pression sur le tas sur chaque chemin de succès. Les tâches terminées sont gratuites.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await VlkTask.WhenAll(...) — jusqu\'à 8 résultats typés. WhenAny retourne le premier résultat complété avec son index.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  "VlkTaskSettings.UnobservedExceptionHandler est configurable par l'utilisateur. Par défaut : enregistre dans Debug.LogException afin qu'aucune exception ne soit jamais silencieuse.",
      },
    },
  ],
  ...
  cta: {
    ...
    p1:         "Gratuit pour les particuliers et les studios avec moins de 1 M$/an de chiffre d'affaires.",
