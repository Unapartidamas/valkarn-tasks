...
const data = {
  hero: {
    pill:  'Unity 2023.1+ · MIT · مجاني للجميع',
    h1:    'Async/await',
    h1Grad:'بدون نفايات.',
  ...
  features: [
    { icon: '⚡', title: 'صفر تخصيص',             desc: 'يتجنب ValkarnTask المبني على البنية الضغط على كومة الذاكرة في كل مسار ناجح. المهام المكتملة لا تُكلف شيئًا.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await ValkarnTask.WhenAll(...) — حتى 8 نتائج مكتوبة. WhenAny يُرجع أول نتيجة مكتملة مع فهرسها.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'ValkarnTaskSettings.UnobservedExceptionHandler قابل للتكوين من قِبل المستخدم. الافتراضي: يُسجل إلى Debug.LogException حتى لا يضيع أي استثناء.',
      },
    },
  ],
  ...
  cta: {
    ...
    p1:         'MIT مفتوح المصدر — مجاني للجميع. ترخيص تجاري اختياري متاح.',
