...
const data = {
  ...
  features: [
    { icon: '⚡', title: 'Null Allokationen',          desc: 'Struct-basierte ValkarnTask vermeidet Heap-Druck auf jedem Erfolgspfad. Abgeschlossene Tasks sind kostenlos.' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await ValkarnTask.WhenAll(...) — bis zu 8 typisierte Ergebnisse. WhenAny gibt das erste abgeschlossene Ergebnis mit seinem Index zurück.',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'ValkarnTaskSettings.UnobservedExceptionHandler ist benutzerkonfigurierbar. Standard: Protokolliert über Debug.LogException, sodass keine Ausnahme jemals lautlos ist.',
      },
    },
  ],
