...
const data = {
  ...
  features: [
    { icon: '⚡', title: 'शून्य आवंटन',              desc: 'Struct-आधारित VlkTask हर सफल पथ पर हीप दबाव से बचता है। पूर्ण tasks निःशुल्क हैं।' },
  ...
  rows: [
    ...
    },
    {
      ...
      note: {
        ...
        valkarn: 'var (tex, sfx, data) = await VlkTask.WhenAll(...) — 8 typed results तक। WhenAny अपने index के साथ पहला completed result लौटाता है।',
      },
    },
    {
      ...
      note: {
        ...
        valkarn:  'VlkTaskSettings.UnobservedExceptionHandler user-configurable है। Default: Debug.LogException पर log करता है ताकि कोई exception कभी silent न हो।',
      },
    },
  ],
