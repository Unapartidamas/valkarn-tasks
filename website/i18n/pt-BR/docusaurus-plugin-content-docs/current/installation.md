...
Você também deve ver as regras do analisador ativas — tente escrever um método `async VlkTask` e esqueça intencionalmente um `await`. O analisador irá sinalizá-lo imediatamente.
